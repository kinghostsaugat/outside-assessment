			...
			<nav class="mobile-nav">
				...
				<div class="mobile-menu">
					...
					<div class="menu">
						...
						<ul>
							<li class="menu-item"><span>Mealtime</span>
								<div class="mega-menu">

									<h2><i></i>Shop Mealtime</h2>
									<div class="submenu">
										<ul>
							...
							<li class="menu-item"><span>Gift</span></li>
							<li class="menu-item"><span>Best Sellers</span></li>
						</ul>
					</div>
				</div>
			</nav>
			<nav class="desk-nav">
				...
				<nav class="main-nav">
					...
					<ul class="menu">
							...
							<div class="mega-menu">
								<div class="submenu">
									<ul>
										...
										<li><span>Submenu Item 5</span></li>
										<li><span>Submenu Item 6</span></li>
										<li><span>Submenu Item 7</span></li>
										<li><span>Submenu Item 8</span></li>
									</ul>
								</div>
								<div class="product-carousel">
									<div class="product">Product 1</div>
						...
						<li class="menu-item">
							<span>The Play Boxes</span>
							<sup>New!</sup>
							<div class="mega-menu">
								<div class="submenu">
									<h2>Shop The Play Boxes</h2>
									<ul>
										<li><span>Play Box Subscription<i></i></span></li>
										<li><span>Newborn Box</span></li>
										<li><span>Gift Play Boxes</span></li>
										<li><span>All Play Boxes</span></li>
									</ul>
								</div>
								<div class="tabs">
									<ul class="nav-tabs">
										...
										<li class="nav-item">
											<button class="nav-link" id="tab-title-2__0" data-bs-toggle="tab" data-bs-target="#tab-title-2-content__0" type="button">
												Year 2
											</button>
										</li>
									</ul>
